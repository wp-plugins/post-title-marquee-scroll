...
function ptms_option() 
{
    ...
    <ul>
    	<li>Check official website for more info <a href="http://www.gopipulse.com/work/2011/08/08/post-title-marquee-scroll-wordpress-plugin/" target="_blank">Click here</a></li>
    </ul>
    <?php
}
